...
async function main() {
    ...
    const coursesData = [
        { title: 'Tiếng Đức sơ cấp A1', teacherEmail: 'muller@linguagerman.vn', level: client_1.CourseLevel.A1, price: 500000, thumbnail: '/courses/a1.png' },
        { title: 'Chinh phục A2 trong 3 tháng', teacherEmail: 'muller@linguagerman.vn', level: client_1.CourseLevel.A2, price: 750000, thumbnail: '/courses/a2.png' },
        { title: 'Tiếng Đức trung cấp B1', teacherEmail: 'schmidt@linguagerman.vn', level: client_1.CourseLevel.B1, price: 1200000, thumbnail: '/courses/b1.png' },
        { title: 'Luyện thi B2 cấp tốc', teacherEmail: 'weber@linguagerman.vn', level: client_1.CourseLevel.B2, price: 2500000, thumbnail: '/courses/b2.png' },
        { title: 'Master C1 - Reading & Listening', teacherEmail: 'wagner@linguagerman.vn', level: client_1.CourseLevel.C1, price: 3500000, thumbnail: '/courses/c1.png' },
    ];
